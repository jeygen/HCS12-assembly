...
LCD_CNTR    EQU PTJ
LCD_E       EQU $80     ;LCD E-signal pin     from lab 4
LCD_RS      EQU $40     ;LCD RS-signal pin    from lab 4
...
DISPATCHER  CMPA #START       ;If it’s the START state -----------------
            ...
            BRA DISP_EXIT     ;and exit                                 
                              ;                                         
NOT_START   CMPA #FWD         ; else if forward state
            BNE NOT_FWD       ;
            JSR FWD_ST        ;
            JMP DISP_EXIT     ;                                         
                              ;
NOT_FWD     CMPA #REV         ;  else if reverse state
            BNE NOT_REV       ;
            JSR REV_ST        ;
            JMP DISP_EXIT     ;
                              ;
NOT_REV     CMPA #ALL_STP     ; else if all stop state
            BNE NOT_ALL_STOP  ;
            JSR ALL_STP_ST    ;
            JMP DISP_EXIT     ;
                              ;
NOT_ALL_STOP CMPA #FWD_TRN    ; else if forward turn state
            BNE NOT_FWD_TRN   ;
            JSR FWD_TRN_ST    ;
            JMP DISP_EXIT     ;                                         
                              ;                                         
